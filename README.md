...
```bash
git clone https://github.com/frankcheng-coder/pollen_forecast.git
cd pollen_forecast
xcodegen generate
...
```
pollen_forecast/              # Repository root
├── README.md
├── LICENSE
├── .gitignore
├── project.yml               # xcodegen spec
├── PollenCast.xcodeproj/     # Generated by xcodegen (not committed)
├── PollenCast/               # App target
...
│   └── Resources/            # Assets
├── PollenCastTests/          # Unit tests
└── PollenCastUITests/        # UI tests
```
